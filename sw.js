const CACHE_NAME='jesus-matrix-v1-20260529-revelation';
const ASSETS=['./','./index.html','./manifest.json','./hubs/index.html','./hubs/assets/maps/incarnation-hub-map.png','./hubs/assets/maps/ministry-hub-map.png','./hubs/assets/maps/revelation-hub-map.png','./icons/icon-192.png','./icons/icon-512.png'];
